...
public class ProxyPlayerCompletionHandler implements CommandCompletions.AsyncCommandCompletionHandler<VelocityCommandCompletionContext> {
    ...
    public Collection<String> getCompletions(VelocityCommandCompletionContext context) throws InvalidCommandArgument {
        return this.plugin.getRedis().getPlayerNames();
    }
}
